...
/**
 * Crie uma classe que implemente a interface Comparator usando como critério de comparação a idade de funcionários.
 * Crie três funcionários adicionando-os em um TreeSet.
